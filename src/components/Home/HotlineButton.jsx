...
const HotlineButton = () => {
    return (
        <div className="fixed bottom-6 left-6 z-50 flex items-center gap-2 bg-header text-white px-4 py-2 rounded-full shadow-lg cursor-pointer hover:scale-105 transition-all">
