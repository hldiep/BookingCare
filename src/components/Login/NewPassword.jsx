            ...
            <div className="bg-white/90 backdrop-blur-md shadow-2xl rounded-3xl px-10 py-12 w-full max-w-md">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className={`w-full text-white font-semibold py-2 mt-6 rounded-full transition-all duration-300 ${loading ? 'bg-gray-400 cursor-not-allowed' : 'bg-logo hover:bg-yellow-600'
                            }`}
                    >
