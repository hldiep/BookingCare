        ...
        <header className="bg-gray-900 fixed top-0 left-0 w-full z-40 shadow-md h-16 flex items-center">
            <div className="w-full max-w-7xl mx-auto px-6 flex justify-between items-center">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button
                        onClick={() => navigate('/')}
                        className="flex items-center gap-2 px-4 py-2 bg-blue-600 border border-blue-600 text-white rounded-lg hover:bg-transparent hover:text-blue-600 transition"
                    >
                        <LogOut size={18} />
                        <span>Đăng xuất</span>
                    </button>
